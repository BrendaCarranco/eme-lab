...
<React.Fragment>
    ...
    <TableHead>
        <TableRow>
            ...
            <StyledTableCell>Ver más</StyledTableCell>
        </TableRow>
    </TableHead>
            <TableBody>
                            {
                                                    ...
                                                    <Table class="table table-striped">
                                                        <TableHead>
                                                            <TableRow>
                                                                ...
                                                                <TableCell>Detalles Extra</TableCell>
                                                            </TableRow>
                                                        </TableHead>
                                                        <TableBody>
                                                            <TableRow>
                                                                <TableCell><Button color="default" href={cot.fileLink} target="_blank" onClick={() => updateStatus(cot.id)} >Descargar</Button></TableCell>
